      ...
      <div class="container-fluid px-md-5 mt-3 mb-3">
        <div class="row mx-lg-4  mx-auto px-auto">
          ...
          <div class="offset-lg-0  offset-xl-0 offset-sm-1 col-md-6 col-lg-4 col-xl-4">
            <div id="first">
              <div class="myform form " style=" margin-top: 80px; background-color: rgb(255,255,255);border-radius:25px;">
              <div class="card text-center" style="border-radius:25px;">
            <div class="card-header">
              <h3 class="card-title" style="font-weight:bold; ">Thanks for signing up!</h3>
            </div>
            <div class="card-body">

              <h4 class="card-text" style="font-weight:bold; font-size:Medium;">Verify your email address</h4>
              <p class="card-text" style="font-weight:bold; color:black;font-size:Small;">Please confirm that you want to use this as your email address</p>
