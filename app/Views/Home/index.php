        ...
        <div class="col-12 hero-text-image">
          <div class="row">
            <div class="col-lg-7 text-center text-lg-left">
              ...
              <p class="class=" mb-5" data-aos="fade-right" data-aos-delay="100">Pigeon makes it easy to send campaigns to the right people at the right time—and most importantly, to motivate customers to come back into our app.</p>

            </div>
            <div class="col-lg-5 iphone-wrap text-center text-lg-right">
              <img src="<?= $base ?>img/email.jpg" class="wrap-image" width="400" height="350" style=" border-radius: 25px;" data-aos="fade-right">
